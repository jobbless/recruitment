<?php
	...
	$dbUsername = 'root';
	$dbPassword = '';
	$dbDatabase = 'recruitment';
	$appURI = 'recruitment';
	$host = 'localhost';

	$adminConfig = array(
		'adminUsername' => "recruitment",
		'adminPassword' => "\$2y\$10\$.GXMDMVOOtbWBWVgebdRluY9OckfIz1swh8TRP.B5.y7bytUcquz2",
