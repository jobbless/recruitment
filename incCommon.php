	...
	*/
	...
	function getTableList($skip_authentication = false) {
		...
		$arrTables = array(
			...
			'Shortlisted_Applicant_Details' => array('Shortlisted Applicant Details', '', 'table.gif', 'None'),
			'MEDICAL_EXAMINATION' => array('MEDICAL EXAMINATION', '', 'table.gif', 'None'),
			'INTERVIEW_RESULTS' => array('INTERVIEW RESULTS', '', 'table.gif', 'None')
		);
	...
	function get_sql_fields($table_name) {
		$sql_fields = array(
			'Shortlisted_Applicant_Details' => "`Shortlisted_Applicant_Details`.`Serial_Number` as 'Serial_Number', if(`Shortlisted_Applicant_Details`.`Shortlist_date`,date_format(`Shortlisted_Applicant_Details`.`Shortlist_date`,'%m/%d/%Y'),'') as 'Shortlist_date', `Shortlisted_Applicant_Details`.`First_Name` as 'First_Name', `Shortlisted_Applicant_Details`.`Middle_Name` as 'Middle_Name', `Shortlisted_Applicant_Details`.`Last_Name` as 'Last_Name', `Shortlisted_Applicant_Details`.`Level_of_Education` as 'Level_of_Education', if(`Shortlisted_Applicant_Details`.`DOB`,date_format(`Shortlisted_Applicant_Details`.`DOB`,'%m/%d/%Y'),'') as 'DOB', `Shortlisted_Applicant_Details`.`Age` as 'Age', `Shortlisted_Applicant_Details`.`District_of_Origin` as 'District_of_Origin', `Shortlisted_Applicant_Details`.`Recruitment_centre` as 'Recruitment_centre', `Shortlisted_Applicant_Details`.`Gender` as 'Gender', `Shortlisted_Applicant_Details`.`Telephone_Contact` as 'Telephone_Contact', `Shortlisted_Applicant_Details`.`Religion` as 'Religion', `Shortlisted_Applicant_Details`.`Nationality` as 'Nationality', `Shortlisted_Applicant_Details`.`NIN` as 'NIN', `Shortlisted_Applicant_Details`.`Tribe` as 'Tribe', `Shortlisted_Applicant_Details`.`Special_attribute` as 'Special_attribute', `Shortlisted_Applicant_Details`.`OLevel_School` as 'OLevel_School', `Shortlisted_Applicant_Details`.`English_Grade` as 'English_Grade', `Shortlisted_Applicant_Details`.`Math_Grade` as 'Math_Grade', `Shortlisted_Applicant_Details`.`Description` as 'Description', `Shortlisted_Applicant_Details`.`Total_Mark` as 'Total_Mark'",
			'MEDICAL_EXAMINATION' => "`MEDICAL_EXAMINATION`.`Medical_Examination_ID` as 'Medical_Examination_ID', `MEDICAL_EXAMINATION`.`First_name` as 'First_name', `MEDICAL_EXAMINATION`.`Middle_name` as 'Middle_name', `MEDICAL_EXAMINATION`.`Last_name` as 'Last_name', `MEDICAL_EXAMINATION`.`Name_of_Medical_officer` as 'Name_of_Medical_officer', if(`MEDICAL_EXAMINATION`.`Examinaton_date`,date_format(`MEDICAL_EXAMINATION`.`Examinaton_date`,'%m/%d/%Y'),'') as 'Examinaton_date', `MEDICAL_EXAMINATION`.`Result` as 'Result', `MEDICAL_EXAMINATION`.`Remark` as 'Remark', `MEDICAL_EXAMINATION`.`Place_of_Examination` as 'Place_of_Examination'",
			'INTERVIEW_RESULTS' => "`INTERVIEW_RESULTS`.`Interview_ID` as 'Interview_ID', `INTERVIEW_RESULTS`.`Written_interview` as 'Written_interview', `INTERVIEW_RESULTS`.`Oral_Interview` as 'Oral_Interview', `INTERVIEW_RESULTS`.`Total_Mark` as 'Total_Mark', if(`INTERVIEW_RESULTS`.`Interview_Date`,date_format(`INTERVIEW_RESULTS`.`Interview_Date`,'%m/%d/%Y'),'') as 'Interview_Date', `INTERVIEW_RESULTS`.`Remark` as 'Remark', `INTERVIEW_RESULTS`.`Selection` as 'Selection'",
		);
	...
	function get_sql_from($table_name, $skip_permissions = false, $skip_joins = false) {
		$sql_from = array(
			'Shortlisted_Applicant_Details' => "`Shortlisted_Applicant_Details` ",
		...
		$pkey = array(
			'Shortlisted_Applicant_Details' => 'Serial_Number',
			'MEDICAL_EXAMINATION' => 'Medical_Examination_ID',
	...
	function get_defaults($table) {
		...
		$defaults = array(
			'Shortlisted_Applicant_Details' => array(
				'Serial_Number' => '',
				'Shortlist_date' => '',
				'First_Name' => '',
				'Middle_Name' => '',
	...
	function htmlUserBar() {
		...
		<nav class="navbar navbar-default navbar-fixed-top hidden-print" role="navigation">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="<?php echo PREPEND_PATH; ?>index.php"><i class="glyphicon glyphicon-home"></i> UPS Recruitment</a>
			</div>
